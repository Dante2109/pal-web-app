          ...
          <div className="space-y-4">
            ...
            >
              <div className="hidden print:block text-center py-4 border-b border-gray-200 mb-4">
                <p className="text-xs text-gray-500">MediGuardian &middot; Emergency Medical Profile &middot; Generated {new Date().toLocaleString()}</p>
              </div>
              ...
              <div className="border-t border-border px-4 sm:px-6 py-3 text-center print:px-4 print:py-3">
                <p className="text-[10px] text-warm-gray">
                  Generated by MediGuardian &middot; {new Date().toLocaleString()} &middot; Emergency ID: {result.emergencyId}
                </p>
